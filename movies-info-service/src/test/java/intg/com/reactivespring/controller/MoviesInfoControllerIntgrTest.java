...
class MoviesInfoControllerIntgrTest {
    ...
    void getMovieInfoByNameTest() {
        ...
        var movieInfoName = "Dark Knight Rises";

        webTestClient
                .get()
                .uri(MOVIES_INFO_URL+"name/{name}", movieInfoName)
                .exchange()
                .expectStatus()
                .is2xxSuccessful()
                .expectBody(MovieInfo.class)
    ...
    @Test
    void getMovieInfoById_notFound_Test() {
    ...
    @Test
    void updateMovieInfo_notFound_Test() {
